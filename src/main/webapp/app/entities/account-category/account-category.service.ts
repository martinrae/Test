...
export class AccountCategoryService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/account-categories';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IAccountCategory[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
