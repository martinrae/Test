...
import { YaldayAdminModule } from 'app/admin/admin.module';
import {
    ContactComponent,
...
@NgModule({
    imports: [YaldaySharedModule, YaldayAdminModule, RouterModule.forChild(ENTITY_STATES)],
    declarations: [
        ContactComponent,
        ContactDetailComponent,
        ContactUpdateComponent,
...
export class YaldayContactModule {}
