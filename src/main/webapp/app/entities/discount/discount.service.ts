...
export class DiscountService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/discounts';
    ...
    private convertDateFromClient(discount: IDiscount): IDiscount {
        const copy: IDiscount = Object.assign({}, discount, {
            dateCreated: discount.dateCreated != null && discount.dateCreated.isValid() ? discount.dateCreated.toJSON() : null,
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((discount: IDiscount) => {
            discount.dateCreated = discount.dateCreated != null ? moment(discount.dateCreated) : null;
