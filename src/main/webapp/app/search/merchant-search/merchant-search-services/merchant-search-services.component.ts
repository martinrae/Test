...
@Component({
    selector: 'jhi-merchant-search-service',
    templateUrl: './merchant-search-services.component.html'
})
export class MerchantSearchServicesComponent implements OnInit, OnDestroy {
    ...
    constructor(
        private serviceService: MerchantSearchServicesService,
