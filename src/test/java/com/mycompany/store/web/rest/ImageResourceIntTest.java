...
public class ImageResourceIntTest {
     ...
     *
     * @see com.mycompany.store.repository.search.ImageSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.getDateCreated()).isEqualTo(DEFAULT_DATE_CREATED);
        assertThat(testImage.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testImage.getTag()).isEqualTo(DEFAULT_TAG);
    ...
    public void updateImage() throws Exception {
        ...
        Image testImage = imageList.get(imageList.size() - 1);
        assertThat(testImage.getDateCreated()).isEqualTo(UPDATED_DATE_CREATED);
        assertThat(testImage.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testImage.getTag()).isEqualTo(UPDATED_TAG);
