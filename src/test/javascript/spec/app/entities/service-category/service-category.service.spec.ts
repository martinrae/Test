    ...
    describe('ServiceCategory Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ServiceCategory', () => {
                service.create(new ServiceCategory(null)).subscribe(received => {
            ...
            it('should update a ServiceCategory', () => {
                service.update(new ServiceCategory(123)).subscribe(received => {
            ...
            it('should return a ServiceCategory', () => {
            ...
            it('should return a list of ServiceCategory', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ServiceCategory(123)]);
            });
